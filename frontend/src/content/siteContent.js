  ...
  en: {
    ...
    marathonWelcome: {
      ...
      cards: {
        ...
        teams: {
          title: 'Participating running clubs',
          description:
            'Chinese running clubs from around the world taking on the Chicago Marathon — find one near where you’re traveling and join a group run.',
          cta: 'Open guide',
        },
        sharingSessions: {
      ...
      hotelPage: {
        ...
        bookingDeadline: 'Booking deadline: September 30, 2026.',
        bookingExtendTitle: 'Staying longer than October 9–12?',
        bookingExtendBody:
          'The booking link currently only allows check-in dates between October 9 and 12. If you need extra nights outside that range, book October 9–12 first, then email your confirmation number along with the dates you’d like to add to',
        bookingExtendEmail: 'CHIZO-DOS.Dynamic@hyatt.com',
        bookingExtendFollowUp:
          'We’ll adjust your reservation on our end and send you an updated confirmation email.',
        amenityBreakfast: 'Complimentary breakfast included',
        amenityAirportShuttle: 'Complimentary airport shuttle',
        amenityOvernightParking: 'Overnight parking: $10/night + tax',
      ...
      volunteerPage: {
        ...
        signupDeadline: 'Volunteer sign-up deadline: October 2, 2026.',
      ...
      ticketsPage: {
        ...
        pageTitle: 'Chicago Marathon tickets',
        pageIntro: 'Purchase carb-loading dinner and race-morning bus shuttle tickets securely on Zeffy.',
        carbLoadingTitle: 'Carb-loading dinner',
  ...
  zh: {
    ...
    homeExplore: {
      ...
      marathon: {
        id: 'marathon',
        title: '芝加哥马拉松',
        description: '芝加哥马拉松周末——加碳会、住宿、交通等指南，助您从容参赛。',
        cta: '查看芝马指南',
        to: '/chicagomarathon',
      },
      about: {
    ...
    checkinsFaq: [
      ...
      {
        q: '怎么把照片放在地图上？',
        a: '可以将照片发到驰跑团微信群（群名：芝加哥驰跑团 ChiRunners）里，注明中英文名字、地点、打卡日期和您想表达的一句话。或者把以上信息发到 admin@chirunners.org，收到信息以后，我们会把小旗子和您的照片放到地图上去。',
      },
    ],
    checkinsIntroLines: [
      '驰跑团“全球打卡地图”正式上线啦！无论您的脚步迈向何方：',
      '🏅 挑战各大赛事的激情赛道',
      '🌅 唤醒城市的清爽晨跑',
      '🧳 丈量世界的旅行跑',
      '⛰️ 探索山野的 Trail Run',
      '只要您抵达 比赛终点，或路过 城市地标（Landmark）：',
      '📍 掏出咱们驰跑团的小旗子！',
      '📸 拍下一张专属打卡照！',
    ...
    marathonWelcome: {
      ...
      cards: {
        ...
        teams: {
          title: '参赛跑团',
          description: '来自世界各地的华人跑团相聚芝加哥马拉松——当您旅行时，也能在这里找到当地跑团，参加群跑。',
          cta: '查看详情',
        },
        sharingSessions: {
          title: '跑者分享会',
      ...
      hotelPage: {
        ...
        bookingDeadline: '预订截止日期：2026年9月30日。',
        bookingExtendTitle: '需要预订 10 月 9 日至 12 日以外的日期？',
        bookingExtendBody:
          '目前预订链接最多只能选择 10 月 9 日至 12 日的入住日期。如果您需要更长的入住时间，请预订 10 月 9 日至 12 日，再将确认邮件中的 Confirmation Number，连同您希望增加的日期，发送到',
        bookingExtendEmail: 'CHIZO-DOS.Dynamic@hyatt.com',
        bookingExtendFollowUp: '酒店后台为您调整预订，并重新发送更新后的确认邮件。',
        amenityBreakfast: '含免费早餐',
        amenityAirportShuttle: '机场免费班车（Shuttle）',
        amenityOvernightParking: '夜间停车：$10/晚 + 税',
      ...
      volunteerPage: {
        ...
        introBody:
          '一场马拉松，不只有跑者。\n\n自2015年起，驰跑团每年都会组织志愿者参与芝加哥马拉松相关服务。从 Expo 物资发放，到比赛日的水站，我们用自己的时间和热情，为来自世界各地的跑者加油、送水、提供帮助。\n\n无论您是芝加哥本地的朋友，还是专程从外地来到芝加哥观看马拉松的朋友，我们都欢迎您加入志愿者团队。尤其对于外地来的朋友，和本地跑友一起做义工，不仅可以认识新朋友，还能从当地人的视角了解芝加哥的文化、城市故事和许多有趣的事情，体验一个不一样的芝加哥。\n\n只要年满14岁，无论您是第一次参加马拉松志愿服务，还是曾经多年服务过的老朋友，都欢迎加入我们。\n\n比赛当天，当您站在17号水站，为跑者递上一杯水、送上一声加油时，您也成为了这场马拉松的一部分。\n\n2026年，我们期待120位志愿者加入我们，用一杯水、一声加油、一份热情，为奔跑中的每一个人加油！',
        ...
        signupDeadline: '义工报名截止日期：2026年10月2日。',
      ...
      ticketsPage: {
        docTitle: '芝马购票 · 驰跑团',
        pageTitle: '2026芝加哥马拉松购票',
        carbLoadingTitle: '加碳会门票',
      ...
      transportationPage: {
        ...
        sections: {
          airportHotel: {
            ...
            lead:
              '多数朋友从奥黑尔机场（ORD）入境。酒店位于罗斯蒙特（Rosemont），离机场很近。您可以乘坐酒店免费班车；若人在租车中心附近，也可以像我们一样步行回酒店。',
